...
namespace PaywaveAPIMongoDataService
{
    internal class MongoDataBase
    {
        ...
        public async Task<bool> InsertRecord<T>(string table, T record)
        {
            try
            {
        ...
        public async Task<List<T>> GetAllRecord<T>(string table)
        {
            try
            {
                var collection = db.GetCollection<T>(table);
        ...
        //Bad code implementaion
        //public async Task<string> LoadAllRecord<T>(string table)
        //{
        //    try
        //    {
        //        var collection = db.GetCollection<T>(table);
        //        var filter = Builders<T>.Filter.Empty;
        //        var data = await collection.DeleteManyAsync(filter);
        //        return data.DeletedCount.ToString();
        //    }
        //    catch (Exception ex)
        //    {
        //        Console.WriteLine(ex.Message);
